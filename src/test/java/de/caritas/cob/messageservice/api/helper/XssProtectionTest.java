...
class XssProtectionTest {
  ...
  @Test
  void escapeHtml_Should_escapeJavascriptCode() {
  ...
  @Test
  void escapeHtml_Should_escapeHtmlFromText_And_ShouldNot_removeNewlines() {
  ...
  @Test
  void removeHTMLFromText_Should_returnEmptyString_When_inputIsNull() {
  ...
  @Test
  void removeHTMLFromText_Should_returnEmptyString_When_inputIsEmptyString() {
    String normalized = escapeHtml("");
